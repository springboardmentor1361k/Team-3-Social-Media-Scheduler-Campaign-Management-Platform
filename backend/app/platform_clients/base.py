...
class BasePlatformClient(abc.ABC):
    ...
    def get_engagement(self, platform_post_id: str, access_token: str) -> Dict[str, Any]:
        """
        Fetch engagement metrics from the social platform for a given post.
        Should return a dictionary containing metrics, e.g.:
        {"impressions": int, "reach": int, "engagements": int, "clicks": int}
        If the API call fails or requires missing scopes, it should return mock fallback data.
        """
        ...
